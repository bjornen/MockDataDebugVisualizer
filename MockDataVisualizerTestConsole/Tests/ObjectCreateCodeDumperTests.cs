...
namespace MockDataVisualizerTestConsole.Tests
{
    public class ObjectCreateCodeDumperTests
    {
        ...
        public void Can_dump_object()
        {
            ...
            var dump = Dumper.DumpInitlizationCode(root);
        ...
        public void Can_create_complete_create_method()
        {
            ...
            var dump = Dumper.DumpInitilizationCodeMethod(root);
        ...
        public void Can_dump_serviced_entity()
        {
            ...
            var dump = Dumper.DumpInitlizationCode(servicedEntity);
        ...
        public void Can_dump_boolean()
        {
            ...
            var dump = Dumper.DumpInitlizationCode(bo);
        ...
        public void Can_dump_Customer()
        {
            ...
            var dump = Dumper.DumpInitlizationCode(masterCustomer);
        ...
        public void Can_dump_customer_household()
        {
            ...
            var dump = Dumper.DumpInitlizationCode(customer);
        ...
        public void Can_resolve_init_type_name_for_serviced_entity()
        {
            ...
            var dumper = Dumper.ResolveInitTypeName(se.GetType());
        ...
        public void Can_resolve_init_type_name_for_object()
        {
            ...
            var initName = Dumper.ResolveInitTypeName(obj.GetType());
        ...
        public void Can_dump_enum()
        {
            ...
            var dump = Dumper.DumpInitlizationCode(enumObject);
        ...
        public void Can_dump_non_public_ctor()
        {
            ...
            var dump = Dumper.DumpInitlizationCode(obj);
        ...
        public void Can_dump_List()
        {
            ...
            var dump = Dumper.DumpInitlizationCode(list);

            Assert.Equal("\r\nvar list_0 = new List<Foo>();\r\nvar Foo_1 = new Foo();\r\nFoo_1.FooValue = \"1\";\r\nSetValue(Foo_1, \"_privateFooField\", 0);\r\nlist_0.Add(Foo_1);\r\nvar Foo_2 = new Foo();\r\nFoo_2.FooValue = \"2\";\r\nSetValue(Foo_2, \"_privateFooField\", 0);\r\nlist_0.Add(Foo_2);", dump);
        }
        ...
        public void Can_dump_string_string_dictionary()
        {
            ...
            var dump = Dumper.DumpInitlizationCode(dic);

            Assert.Equal("\r\nvar dictionary_0 = new Dictionary<String, String>();\r\ndictionary_0.Add(\"key\", \"value\");", dump);
        }
